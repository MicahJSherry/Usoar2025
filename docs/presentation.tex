...
\begin{document}
    ...
    \begin{frame}{Definitions}
        \begin{itemize}
            \item A semifield is an algebraic structure with addition and multiplication. That does not have additive inverses.
    ...
    \begin{theorem}
        ...
        $|G_n| = F(n+2)$ for $n \geq 1$ 
    \end{theorem}
        \begin{proof}[Proof (by Strong induction)]    
            \noindent $G_1 = \{x, 0x\}, \quad |G_1| = 2 = F(3)$
            \enspace \& \enspace
            $G_2 = \{x^2+x,\; x^2,\; x\}, \quad |G_2| = 3 = F(4)$
            
            Therefore the base cases hold. Assume that $|G_j| = F(j+2)$ for all $j \in \{1, 2, \ldots, k\}$ for some $k$. 
    ...
    \begin{frame}{Unique factorization Examples}    
        \begin{tabular}{|l|l|l|}
            \hline
    ...
    \begin{frame}{Current Work}
        \begin{enumerate}
            \item Establishing $\prod_{i=1}^{n}Fibb(i)$ as a lower bound of number of unique factors.
